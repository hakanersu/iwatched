<template>
    <div>
        ...
        <div class="min-h-screen" :class="[containerClass]">
            <nav class="bg-white border-b border-gray-100" :class="[navigationClass]">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link v-else :href="route('welcome')" :active="route().current('welcome')">
                                 ...
                                 <jet-nav-link :href="route('series.index')" :active="route().current('series.*')">
                                    Tv Series
                                </jet-nav-link>
                            </div>
                        </div>
